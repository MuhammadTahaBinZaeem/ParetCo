...
// The older round-two endpoint probes predate native-verified AI contracts.
// Upgrade those requests before the existing startup chain executes.
...
`    const autoJob = demoPayload();
    const autoGoal = 'Make a small feasible numeric architecture adjustment while preserving existing ARM model and mode identifiers.';
    const auto = await requestJson('/api/ai/auto-optimize', {
